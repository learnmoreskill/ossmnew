...
(function ($) {
    ...
    $.extend(calendarFunctions, {
        ...
        parseFormattedBsDate: function (dateFormat, dateFormattedText) {
            ...
            //KRISHNA MODIFY STARTED       
            
            var allelement = dateFormattedText.split('-');
            var nepaliformateddatekkm = parseInt(allelement['0'])+','+parseInt(allelement['1'])+','+parseInt(allelement['2']); // "२०७५-११-१५"
            
            dateFormattedText = calendarFunctions.bsDateFormat("%y-%m-%d",parseInt(allelement['0']),parseInt(allelement['1']),parseInt(allelement['2'])); 
            
            //KRISHNA MODIFY ENDED
