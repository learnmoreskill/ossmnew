...
$teacher_account_details = json_decode($account->get_teacher_payment_record_by_teacher_id_date($teacher_id,$date));
...
if(isset($_REQUEST['teacher_id_by_two_date']))
{
	...
	$teacher_details =  json_decode($account->get_teacher_record_by_tid($teacher_id));
	$teacher_account_details = json_decode($account->get_student_statement_by_student_id_and_twodate($teacher_id,$first_date,$second_date));
    ...
    <div style='display:none;' id='teacher_payment_details'>            
       ...
       <hr>
        ...
        <hr>            
                        ...
                        <table id='studentDetailsTable' class='table-border table table-striped b-t b-light' style='background:white;margin-top:10px;'>
                            <thead>
                                <tr>
                                  <th scope='col'>S.N.</th>
