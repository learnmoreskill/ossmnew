...
{
	$result = $account->insertExpensesCategory($_REQUEST['category']);
  if ($account) {
          ...
          foreach($expenses_category_list as $key)
          {
            ...
            echo "<tr>
              ...
              <td>
                ...
                <td>";
                    //echo" <button style='padding:0px 5px;' onclick='delete_expenses_category(".$key->ecat_id.")' type='button' class='btn btn-danger' title='Delete'><i class='fa fa-remove'></i> Delete</button>;"
             echo "</td>
