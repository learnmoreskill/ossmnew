...
if(isset($_GET['student_id'])){
  ...
  echo "<tr>
    ...
    <td></td>
    <td></td>
    <td style='padding-right:0'><span class='text-danger'>Total Balance:</span><br><span class='text-success'>Advance Paid:</span><hr><b class='text-info'>Total Payable:</b> </td>
    <td  > <span class='text-danger' id='total_balance'>".$all_balance."</span><br>
    <span class='text-success' id='advPaid'>".$advanceAmount."</span><hr style='margin-left:-10px'>
    <b><span class='text-info' id='total_payable'>".((float)$all_balance-(float)$advanceAmount)."</span></b> </td>
    <td class='action'>
      <a class='btn btn-success btn-block submitModal' style='color:#fff;width:90%;' data-target='.bd-example-modal-lg' data-whatever='".$student_id."'><i class='fas fa-money-bill-alt'></i> Pay</a>

      <a class='btn btn-info btn-block' style='color:#fff;width:90%;' data-target='#advancePayModal' data-whatever='".$student_id."'> <i class='fas  fa-piggy-bank'></i> Advance Pay</a>
      </td>
...
<div id="submitFee" class="modal fade bd-example-modal-lg" aria-hidden="true" tabindex="-1" role="dialog" aria-labelledby="viewModalLabel">
    <div class="modal-dialog modal-lg w-50" style="width: 90%">
