...
<div class="wrapper">
    ...
    <nav id="sidebar" class="" style="position: relative;">
        ...
        <ul class="list-unstyled components">
            <li class="active busId"><a href="#">
                <input type="checkbox" onclick="checkAll()" id='check'/> All<br/></a>
            </li>
        <?php  foreach ($transportation_details as $trans) 
            {   ?>
            <li class="busId"><a href="#"> <label><input type="checkbox" value="<?php echo $trans->bus_number; ?>" name="busIdActive" onclick="handleCheckAllBtn()"><?php echo $trans->bus_number.",".$trans->bus_route; ?></label></a></li> 
            <?php } ?>
        </ul>
