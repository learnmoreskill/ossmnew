              ...
              <thead>
                <tr>
                  ...
                  <th rowspan="2">Student Name</th>
                    ...
                    $resultsubject1 = $db->query("SELECT `subject_id` , `subject_name`,`subject_type`  
                      FROM `marksheet` 
                  ...
                  $subtype = $subjectrow2["subject_type"];
                    ...
                    if ($resultmark->num_rows > 0) {
                      while($submark1 = $resultmark->fetch_assoc()) { ?>
                        ...
                        if($submark1["subject_type"]==1){ ?>
                          ...
                          <td <?php if ($submark1["marksheet_status"] == 1) { echo 'class="red lighten-4"';  }
                            ...
                            <?php if(!empty($submark1["m_theory"])){ echo $submark1["m_theory"]; }else{ echo "-"; } 
                              ...
                              echo (($submark1["m_theory"]<$submark1["theory_passmark"])? '*':'');
                        ...
                        <?php 
                            if($submark1["subject_type"]==0 && $submark1["m_obtained_mark"] >= $submark1["pass_mark"]) {
                            }else if($submark1["subject_type"]==1 && $submark1["m_theory"] >= $submark1["theory_passmark"]) {
                            }else if($submark1["subject_type"]==3) {
                            }else{
                              $fail = 1;
                            }
                      ...
                      <td class="brown lighten-3">
                        ...
                        if($fail == 1){ echo "&nbsp&nbsp&nbsp f"; } ?>
                      </td>
