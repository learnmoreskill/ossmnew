...
/*======================== start multiple bus creation ===================*/
          //For multiple buses
            function startmultiplebus(){  
                ...
                success: function (obj, textstatus) {
                    if( !('error' in obj) ) {
                        ...
                        businfo.forEach(function(element) {
                                ...
                                if (!google || google === null || google === undefined){ window.location.href= window.location.href; alert("please refresh this plaese or click ok to refresh.."); }
          ...
          function removemarker(busname){
            debugger;
            Markers[busname].setMap(null);
            delete  Markers[busname];
            return;
          }
/*======================== end multiple bus creation ===================*/
          ...
          success: function (obj, textstatus) {
              if( !('error' in obj) ) {
                  ...
                  buslist.forEach(function(element) {
                    ...
                    dynamicHTML += '<li class="busId"><a href="#"> <label><input type="checkbox" value="'+element.name+'" name="busIdActive" onclick="handleCheckAllBtn(); selectCurrent(this);">'+element.name+'</label></a></li>';
