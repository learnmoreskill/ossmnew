                  ...
                  <div class="card-content white-text">
                    ...
                    <div class="row">
                      <form class="col s12" id="sendbroadcastbyprincipal" action="sendbroadcastscript.php" method="post">
                        ...
                        <div class="row" id="classDiv" >
                          <div class="input-field col s12">
                            <select multiple name="classes[]" id="classes">
                              ...
                              <option value="<?php echo $clist->class_id; ?>" selected><?php echo $clist->class_name; ?></option>
                              <?php } ?>
                            </select>
                        ...
                        <div class="row">
                          <div class="input-field col s12">
                              <textarea id="topic" name="broadcastmessage" class="materialize-textarea"  length="160" ><?php echo "-".$login_session_a; ?></textarea>
