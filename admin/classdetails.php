...
<?php include_once("navbar.php");?>
  ...
  <?php if($login_cat==1 || $pac['edit_class']){ ?>
      <div class="row">
            ...
            <div class="col s12 m7">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $monthly_test_fee; ?></td>
                    </tr>
                    <tr>
                        <td>Uniform Fee</td>
    ...
    <div class="modal-content">
      <form id="update_class_form" action="updatescript.php" method="post" >
        ...
        <div class="row">
            ...
            <div class="col s2">
                <h6 style="padding-top: 20px">Sort order</h6>
            </div>
            <div class="input-field col s3">
              <input name="sort_order" id="sort_order" type="number" value="<?php echo $sort_order; ?>" placeholder="e.g. 5" min="0" max="99" required >
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s3">
              <input name="monthly_test_fee" id="monthly_test_fee" type="text" value="<?php echo $monthly_test_fee; ?>">
            </div>
        </div>
        <div class="row">
            <div class="col s2">
