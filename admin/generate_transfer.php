...
$_SESSION['navactive'] = 'generate_transfer';
        ...
        <main>
            <div class="section no-pad-bot" id="index-banner">
                ...
                <div class="github-commit">
                    <div class="container">
                        <div class="row center"><a class="white-text text-lighten-4" href="#">Generate transfer certificate</a></div>
                    </div>
                </div>
            </div>
            <div class="row">
              <div class="col s12 m12">                
                ...
                <form target="_blank" action="printtransfer.php" method="post" >
                  ...
                  <div class="card blue-grey">
                    <div class="row"><br>
                        ...
                        <div class="input-field col m2">
                             <button class="btn waves-effect waves-light" type="submit" name="generate_multiple_transfer" value="generate_multiple_transfer" >Submit
                                    ...
                                    <div class="row">
                                      <form target="_blank" action="printtransfer.php" method="post">
                                        ...
                                        <div class="input-field col offset-m10">
                                          <button class="btn waves-effect waves-light" type="submit" name="generate_single_transfer" value="generate_single_transfer" >Submit<i class="material-icons right">send</i>
                                          </button>
                                        </div>
                                      </form>                                  
                                    </div>
