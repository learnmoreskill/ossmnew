...
<div style="position: relative; border: 3px solid red;border-radius: 10px;width:45%;float:left;margin-left: 18px;margin-right: 8px;margin-top: 15px;margin-bottom: 16px;height:47%;">
                ...
                <tr>
                    <td align="center">
                      <tr align="center">
                        ...
                        <td style="">
                         <p style="font-size: 20px;font-weight: bold;font-style: bold;margin-top: -20px;margin-left:-20px; text-transform: capitalize;"><?php echo $school_details->school_name; ?></p>
        ...
        <tbody>
            ...
            <div style="position: absolute; bottom: 10px;width: 100%; ">
              <P style="padding: 0 10px;">
                ...
                <?php if (!empty($school_details->acc_sign)) {  ?>
                  <div style="top: 0px;position: absolute;left: 30px; z-index: 999;">
                    <img src="../uploads/<?php echo $fianlsubdomain; ?>/logo/<?php echo $school_details->acc_sign; ?>" style="height: 30px;width: 70px;margin-bottom: -7px;">
                  </div>
              <?php } ?> 
              ...
              <?php if (!empty($school_details->sign)) { ?>
                  <div style="top: 0px;position: absolute;left: 250px; z-index: 999;">
