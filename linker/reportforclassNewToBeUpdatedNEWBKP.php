...
<!-- ====================  Grade, GPA, Rank, HS , Test Marksheet     ==================== -->
    <?php
  }else if($template == 5 && $mfound==1 && $print_format == 'a5'){
    ...
    <?php 
  }else if($template == 5 && $mfound==1 && $print_format == 'a4'){
                  ...
                  <!-- <div style="width:146mm; height:208mm;"> -->
                    <div style="z-index: 1; text-align:center; border: 2px solid #787878;position: relative;overflow: hidden;" class="backGreen subpage">
                      ...
                      <div style="display: inline-flex;width:100%;padding: 5px 0">
                        ...
                        <div style="text-align: center;position: relative;padding: 0 20px;margin: auto 60px; ">
                               <h3 style="font-weight: bolder;margin:10px 0;text-transform: uppercase;"><?php echo $login_session_a; ?></h3>
                               <div >
                                  <p style="margin: 0;font-size: 11px;font-family: happyEnding"> <?php echo $login_session_c; ?><br>Estd: <?php echo $login_session_g; ?></p>
                      ...
                      <div style="padding: 0 10px">
                        <div style="margin: 5px auto">
                          <div style="width: 55%;background: #000;margin: auto;">
                            <h4 style="margin: 0;padding: 10px;color: #fff;text-transform: uppercase;"><b><?php echo $examtype_details->examtype_name; if (!empty($rowstd["month"]) || $rowstd["month"]!=0) { echo ' ( '.$months[$rowstd["month"]-1].' ) '; } 
                              echo '&nbsp'.$rowstd["single_year"];
                             ?></b>
                            </h4>
                          </div>
                          <h4 style="margin: 15px 0"><span style="border: 1px solid #000; padding: 5px 10%;"><b>MARK-SHEET</b></span></h4>
                        </div>
                        <!-- student detail -->
                        <table style="width:100%;text-align: left; font-size: 13px;margin: 10px 0;">
                          <tr>
                            <td colspan="2">Name : <span><b><?php echo $rowstd['sname']; ?></b></span></td>
                            <td >Roll No. : <b><?php echo $rowstd['sroll']; ?></b></td>
                          </tr>
                        ...
                        <!-- Marks table -->
                        <table style="width:100%;height: 400px" class="marks">
                          <thead style="background: lightgray;">          
                            <tr style="text-align: center;">
                              <th>S.N.</th>
                              <th>Subject</th>
                              ...
                              <?php
                                if ($examIncluded) {
                                  foreach ($examIncludeList as $examinclude) {
                                    ...
                                    $ob +=${'includeMark' . $studentid}[$examinclude->added_examtype_id][$row["subject_id"]];

                                    echo "<td>".${'includeMark' . $studentid}[$examinclude->added_examtype_id][$row["subject_id"]]."</td>";
                                  }
                              ...
                              <?php if ($highestInSubTD){ ?>
                                <td style="text-align: center;">
                                  ...
                                  if ($row["subject_type"]==3){ //for subject type 3
                                    ...
                                    arsort($total_mark_in_each_subject_each_student[$row["subject_id"]]);

                                    echo reset($total_mark_in_each_subject_each_student[$row["subject_id"]]);
