...
if (isset($_GET["token"]) && $_GET["token"] == "potgadd5m7y3ww"){
        ...
        if ($insert_type == "subjectwise"){
          ...
          $sqlcheck77="SELECT `marksheet_id` FROM `marksheet` 
            ...
            if($count77<1){
            ...
            }else{ if($login_cat==1 || $pac['edit_mark']){
              ...
              }else{ ?> <script> alert('Mark already added, Please contact admin for any modification.'); window.location.href = 'addmarks.php'; </script> <?php
              }
            }
...
<?php include_once("navbar.php");?>
  ...
  <main>
    <div class="section no-pad-bot" id="index-banner">
      ...
      <?php 
    if(isset($_GET['token']) && @$_GET['token']=="potgadd5m7y3ww" && @$_GET['i04x20']=="subjectwise") {
        if ($studentfound==1) { 
          ...
          <div class="row">
            <form class="col s12" id="add_mark_form_subjectwise" action="addmarkscript.php" method="post" >
              ...
              <input type="hidden" name="subject_type" id="subject_type"  value="<?php echo $rowsubj["subject_type"]; ?>" >
                      ...
                      <tbody>
                        ...
                        while($row = $resultstudent->fetch_assoc()) { ?>
                            ...
                            <td class="cPaddingLR" style="width: 15%">
                                <input   name="sid[<?php echo $idcount; ?>]"  type="hidden" value="<?php echo $row["sid"];?>">
                                <?php echo $row["sroll"]; ?>
                                
                            </td>
                            <td id="sname<?php echo $idcount; ?>" class="cPaddingLR" style="width: 45%">
                                <?php echo $row["sname"]; ?>
                            ...
                            <?php if ($rowsubj["subject_type"] == 0) { ?>
                              <td class="cPaddingLR" style="width: 40%">
                                <input class="no-margin" name="theoretical[<?php echo $idcount; ?>]" id="o<?php echo $idcount; ?>" type="text" placeholder="eg. 85 (type ab for absent/s for suspend)" required  >                          
                              </td>
                            <?php }else if ($rowsubj["subject_type"] == 3) { ?>
                              <td class="cPaddingLR" style="width: 40%">
                                <input class="no-margin" name="theoretical[<?php echo $idcount; ?>]" id="o<?php echo $idcount; ?>" type="text" placeholder="eg. A+ (type ab for absent/s for suspend)" required  >                          
                              </td>
                            <?php }else if ($rowsubj["subject_type"] == 1) { ?>

                              <td class="cPaddingLR" style="width: 20%">
                                  <input class="no-margin" name="theoretical[<?php echo $idcount; ?>]" id="t<?php echo $idcount; ?>" type="text" placeholder="eg. 65 (type ab for absent/s for suspend)" required >                          
                              </td>

                              <td class="cPaddingLR" style="width: 20%">
                                  <input class="no-margin" name="practical[<?php echo $idcount; ?>]" id="p<?php echo $idcount; ?>" type="text" placeholder="eg. 15 (type ab for absent/s for suspend)" required >                          
                              </td>
                            <?php } ?>
                              <!-- Select/deselect -->
                              <td>
                                <div class="switch">
                                  <label>
                                    <input class="mrrorbot1" id="<?php echo $idcount; ?>" onclick="disableStudent(this.id)" type="checkbox" name="selectstd[<?php echo $idcount; ?>]" checked >
