    ...
    function(a) {
        var b = {
            init: function(b) {
                ...
                return b = a.extend(c, b), this.each(function() {
                    function c() {
                        "undefined" != typeof window.ontouchstart && (I[0].addEventListener("touchstart", l), I[0].addEventListener("touchmove", m), I[0].addEventListener("touchend", n)), I[0].addEventListener("mousedown", l), I[0].addEventListener("mousemove", m), I[0].addEventListener("mouseup", n), I[0].addEventListener("mouseleave", n), I[0].addEventListener("click", j)
                    }
                    ...
                    function f(a) {
                        return a >= u ? a % u : 0 > a ? f(u + a % u) : a
                    }

                    function g(a) {
                        var c, d, e, g, h, i, j;
                        if (q = "number" == typeof a ? a : q, r = Math.floor((q + t / 2) / t), e = q - r * t, g = 0 > e ? 1 : -1, h = -g * e * 2 / t, d = u >> 1, b.full_width ? j = "translateX(0)" : (j = "translateX(" + (I[0].clientWidth - p) / 2 + "px) ", j += "translateY(" + (I[0].clientHeight - p) / 2 + "px)"), J) {
                            var k = r % u,
                                l = H.find(".indicator-item.active");
                            l.index() !== k && (l.removeClass("active"), H.find(".indicator-item").eq(k).addClass("active"))
                        }
                        for ((!b.no_wrap || r >= 0 && u > r) && (i = o[f(r)], i.style[B] = j + " translateX(" + -e / 2 + "px) translateX(" + g * b.shift * h * c + "px) translateZ(" + b.dist * h + "px)", i.style.zIndex = 0, b.full_width ? tweenedOpacity = 1 : tweenedOpacity = 1 - .2 * h, i.style.opacity = tweenedOpacity, i.style.display = "block"), c = 1; d >= c; ++c) b.full_width ? (zTranslation = b.dist, tweenedOpacity = c === d && 0 > e ? 1 - h : 1) : (zTranslation = b.dist * (2 * c + h * g), tweenedOpacity = 1 - .2 * (2 * c + h * g)), (!b.no_wrap || u > r + c) && (i = o[f(r + c)], i.style[B] = j + " translateX(" + (b.shift + (t * c - e) / 2) + "px) translateZ(" + zTranslation + "px)", i.style.zIndex = -c, i.style.opacity = tweenedOpacity, i.style.display = "block"), b.full_width ? (zTranslation = b.dist, tweenedOpacity = c === d && e > 0 ? 1 - h : 1) : (zTranslation = b.dist * (2 * c - h * g), tweenedOpacity = 1 - .2 * (2 * c - h * g)), (!b.no_wrap || r - c >= 0) && (i = o[f(r - c)], i.style[B] = j + " translateX(" + (-b.shift + (-t * c - e) / 2) + "px) translateZ(" + zTranslation + "px)", i.style.zIndex = -c, i.style.opacity = tweenedOpacity, i.style.display = "block");
                        (!b.no_wrap || r >= 0 && u > r) && (i = o[f(r)], i.style[B] = j + " translateX(" + -e / 2 + "px) translateX(" + g * b.shift * h + "px) translateZ(" + b.dist * h + "px)", i.style.zIndex = 0, b.full_width ? tweenedOpacity = 1 : tweenedOpacity = 1 - .2 * h, i.style.opacity = tweenedOpacity, i.style.display = "block")
                    }

                    function h() {
                        var a, b, c, d;
                        a = Date.now(), b = a - D, D = a, c = q - C, C = q, d = 1e3 * c / (1 + b), A = .8 * d + .2 * A
                    }

                    function i() {
                        var a, c;
                        x && (a = Date.now() - D, c = x * Math.exp(-a / b.time_constant), c > 2 || -2 > c ? (g(z - c), requestAnimationFrame(i)) : g(z))
                    }

                    function j(c) {
                        if (F) return c.preventDefault(), c.stopPropagation(), !1;
                        if (!b.full_width) {
                    ...
                    function k(a) {
                        var c = r % u - a;
                        b.no_wrap || (0 > c ? Math.abs(c + u) < Math.abs(c) && (c += u) : c > 0 && Math.abs(c - u) < c && (c -= u)), 0 > c ? I.trigger("carouselNext", [Math.abs(c)]) : c > 0 && I.trigger("carouselPrev", [c])
                    }

                    function l(a) {
                        s = !0, F = !1, G = !1, v = d(a), w = e(a), A = x = 0, C = q, D = Date.now(), clearInterval(E), E = setInterval(h, 100)
                    }

                    function m(a) {
                        var b, c, f;
                        if (s)
                            if (b = d(a), y = e(a), c = v - b, f = Math.abs(w - y), 30 > f && !G)(c > 2 || -2 > c) && (F = !0, v = b, g(q + c));
                            else {
                                if (F) return a.preventDefault(), a.stopPropagation(), !1;
                                G = !0
                            } return F ? (a.preventDefault(), a.stopPropagation(), !1) : void 0
                    }

                    function n(a) {
                        return s ? (s = !1, clearInterval(E), z = q, (A > 10 || -10 > A) && (x = .9 * A, z = q + x), z = Math.round(z / t) * t, b.no_wrap && (z >= t * (u - 1) ? z = t * (u - 1) : 0 > z && (z = 0)), x = z - q, D = Date.now(), requestAnimationFrame(i), F && (a.preventDefault(), a.stopPropagation()), !1) : void 0
                    }
                    var o, p, q, r, s, t, u, v, w, x, z, A, B, C, D, E, F, G, H = a('<ul class="indicators"></ul>'),
                        I = a(this),
                        J = I.attr("data-indicators") || b.indicators;
                    if (I.hasClass("initialized")) return a(this).trigger("carouselNext", [1e-6]), !0;
                    if (b.full_width) {
                        b.dist = 0;
                        var K = I.find(".carousel-item img").first();
                        K.length ? imageHeight = K.on("load", function() {
                            I.css("height", a(this).height())
                        }) : (imageHeight = I.find(".carousel-item").first().height(), I.css("height", imageHeight)), J && I.find(".carousel-fixed-item").addClass("with-indicators")
                    }
                    I.addClass("initialized"), s = !1, q = z = 0, o = [], p = I.find(".carousel-item").first().innerWidth(), t = 2 * p + b.padding, I.find(".carousel-item").each(function(b) {
                        if (o.push(a(this)[0]), J) {
                    ...
                    }), J && I.append(H), u = o.length, B = "transform", ["webkit", "Moz", "O", "ms"].every(function(a) {
                        var b = a + "Transform";
                        return "undefined" != typeof document.body.style[b] ? (B = b, !1) : !0
                    }), a(window).on("resize.carousel", function() {
                        b.full_width ? (p = I.find(".carousel-item").first().innerWidth(), t = 2 * p + b.padding, q = 2 * r * p, z = q) : g()
                    }), c(), g(q), a(this).on("carouselNext", function(a, b) {
                        void 0 === b && (b = 1), z = t * Math.round(q / t) + t * b, q !== z && (x = z - q, D = Date.now(), requestAnimationFrame(i))
