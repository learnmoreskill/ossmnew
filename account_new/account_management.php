...
//================== Bill Tables =======================================
	...
	//hackster 24/jan/2019
	function add_into_bill_tables($bill_number, $bill_type, $due_before, $advance_before, $advance_paid, $due_after, $advance_after, $date, $print_count , $t_role , $t_id){
		require("../config/config.php");

        $result = mysqli_query($db,"INSERT INTO `bill_tables` (`bill_number`, `bill_type`, `due_before`, `advance_before`, `advance_paid`, `due_after`, `advance_after`, `date`, `print_count`, `t_role`, `t_id`) VALUES ('$bill_number', '$bill_type', '$due_before', '$advance_before', '$advance_paid', '$due_after', '$advance_after', '$date', '$print_count' , '$t_role' , '$t_id')");
