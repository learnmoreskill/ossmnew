...
function showCalendar(a) { $("#ndp-nepali-box table").find("tr:gt(0)").remove(), "" === a ? $("#ndp-nepali-box table").append(getDateTable("")) : $("#ndp-nepali-box table").append(getDateTable(a)), "block" == $("#ndp-nepali-box").css("display") && $("#ndp-nepali-box").hide(), $("#ndp-nepali-box").fadeIn(100) }
...
function getDateRows(a, b, c, d, e) {
    for (var f = getNepaliDate(), g = f.split("-"), i = (g[0], get2DigitNo(g[1])), j = get2DigitNo(g[2]), k = "", l = 0; a + b > l; l++) { l % 7 === 0 && (k += "<tr>");
        var m = l - a + 1,
...
function hideCalendarBox(a) { a = "prios" != typeof a ? a : !0, $("#ndp-nepali-box").fadeOut(100), calendarVisible = !1, a && ndpAttr.onChange && ndpAttr.onChange() }
...
function getNepaliMonth(a) { a = parseInt(a, 10);
...
function englishNo2Nep(a) { a = a.toString();
