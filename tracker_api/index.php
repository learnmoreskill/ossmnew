...
echo $fun -> getMsgInvalidParam();
      ...
      } else if ($operation == 'syncLocal') {

        if(isset($data -> user ) && !empty($data -> user) && isset($data -> user -> sno)){

          $user = $data -> user;
          $sno = $user -> sno;

          echo $fun -> syncLocal($sno);
      ...
      } else if ($operation == 'pushLocation') {

        if(isset($data -> user ) && !empty($data -> user) && isset($data -> user -> sno) && isset($data -> user -> latitude) 
          ...
          echo $fun -> pushLocation($sno, $latitude, $longitude);
