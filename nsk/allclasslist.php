...
$_SESSION['navactive'] = 'allclasslist';

   require("../important/backstage.php");
   $backstage = new back_stage_class();

   $classdetails= json_decode($backstage->get_class_list_details());

    $sqlallclass = "SELECT * FROM `class` WHERE `class`.`status` = 0 ORDER BY `class`.`class_name` ASC ";
