        ...
        <main>
            <div class="section no-pad-bot" id="index-banner">
                ...
                <div class="github-commit">
                    <div class="container">
                        <div class="row center"><a class="white-text text-lighten-4" href="#">Homeworks for class:<?php echo $login_session12."-".$login_session13;?></a></div>
                    </div>
                </div>
            </div>
            <div class="row mt-1">
...
$('#homework_history_grid').DataTable({
         ...
         "serverSide": true,
         "ajax":{
            url :"getContentSmart.php?homeworkhistory", // json datasource
