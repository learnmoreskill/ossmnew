...
return e+='<span id="ndp-target-id" style="display:none"></span>',e+='<div class="ndp-corner-all ndp-header">',e+='<a href="javascript:void(0)" id="prev" title="Previous Month" class="ndp-prev"></a>',e+='<a href="javascript:void(0)" id="next" title="Next Month" class="ndp-next"></a>',e+='<span id="currentMonth"></span>',e+="</div>",e+='<div id="npd-table-div">',e+="<table>",e+='<tr class="ndp-days">',e+="<th>Su</th>",e+="<th>Mo</th>",e+="<th>Tu</th>",e+="<th>We</th>",e+="<th>Th</th>",e+="<th>Fr</th>",e+="<th>Sa</th>",e+="</tr>",e+="</table>",e+="</div>",e+="</div>"}function showNdpCalendarBox(t){if(npdCalendarVisible)hideCalendarBox(!1)
...
return t}function getNepaliMonthsInNepali(){return["Baisakh","Jestha","Ashar","Shrawan","Bhadra","Ashoj","Kartik","Mangsir","Poush","Magh","Falgun","Chaitra"]}function getNepaliMonth(t){t=parseInt(t,10)
