...
$_REQUEST['className'];
//echo $_REQUEST['className'];

$account = new account_management_classes();
$school_details = json_decode($account->get_school_details_by_id());
$student_details = json_decode($account->get_student_details_by_className($_REQUEST['className']));
            ...
            <tbody>
                <tr>
                    <td  valign="top" style="width:100%;">
                        ...
                        <br>
                        Class :
                        <?php echo $account->get_student_class_name_by_id($key->sclass)." ".$account->get_section_name_by_section_id($key->ssec); ?>
                        <br> 
                        Date : <?php echo $date; ?>
                        <br><br>           
                    </td>
