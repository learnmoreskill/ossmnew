...
$student_details = json_decode($account->get_student_bill_details($_REQUEST['className']));
$date = $nepaliDate->full;
$fee_details=json_decode($account->get_fee_from_student_bill_with_studentinfo($classname));
        ...
        <table class="table" width="100%"  style="padding-left: 20px;padding-right: 20px;border-top:1px solid #a8adac; font-size:12px;">
            ...
            <tbody>
                ...
                <tr>
                        ...
                        <td><?php echo $classname."-".$account->get_section_name_by_section_id($key->ssec); ?></td>
