              ...
              <div class='panel-body'>
                ...
                <form id='update_form' name='incomeForm'>
                    <div class='form-group'>
                        ...
                        <input required='true' class='form-control' type='text' name='update_income_type' value='<?php echo $income_details->income_type; ?>'/>
                    </div>

                    <div class='form-group'>
                        <label>Amount*</label>
                        <input id='amount' required='true' class='form-control' type='text' name='update_income_amount' value='<?php echo $income_details->income_amount; ?>' disabled>
                    </div>
                     <div class='form-group'>
                      <label>Payment mode</label><br>

                       <label class='radio-inline'><input type='radio' name='update_payment_mode' <?php echo (($income_details->payment_mode=='cash')? 'checked':''); ?> value='cash' disabled>Cash</label>
                      <label class='radio-inline'><input type='radio' name='update_payment_mode' <?php echo (($income_details->payment_mode=='cheque')? 'checked':''); ?> value='cheque' disabled>Cheque</label>
                      <label class='radio-inline'><input type='radio' name='update_payment_mode' <?php echo (($income_details->payment_mode=='bank')? 'checked':''); ?> value='bank' disabled>Bank</label>
                    </div>
                      <?php 
                      if($income_details->payment_mode!='cash'){ ?> 
                        <div id='paymentModeDetailUpdate'>
                           <div class='form-group'>
                            <label for='usr'>Reference No.*</label>
                            <input type='text' class='form-control'
                            name='update_reference_rumber' id='referenceNumber' disabled value='<?php echo $income_details->payment_number; ?>' >
                            </div>
                             <div class='form-group'>
                            <label for='usr'>Bank name*</label>
                            <input type='text' class='form-control' name='update_bank_name' id='bankName' disabled value='<?php echo $income_details->payment_source; ?>' >
                            </div>
                        </div> <?php 
                      } ?>
                    ...
                    <div class='form-group'>
                        ...
                        <input  class='form-control' type='text' name='update_description' value='<?php echo $income_details->income_description; ?>'>
                    </div>
                     <div class='form-group'>
                        <label>Received from*</label>
                        <input  class='form-control' type='text' name='update_received_from' value='<?php echo $income_details->payment_by; ?>' required>
                    </div>
                ...
                <div class='panel-body'>
                    ...
                    <form id='insert_form' name='incomeForm'>
                        <div class='form-group'>
                            ...
                            <input required='true' class='form-control' type='text' name='add_income_type' />
                        </div>
