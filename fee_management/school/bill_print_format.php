...
if(isset($_REQUEST['type'])){
    ...
    if($type=='Student'){
        ...
        if(!empty($bill_details)){
            ...
            //$credit_transaction_list = json_decode($account->get_credit_student_transaction_list_by_bill_id($bill_id));
        ...
        $pay_me_details = json_decode($account->get_pme_details_by_id($bill_id));
    ...
    <div id="invoice_print" style="margin-bottom: 20px;">
        ...
        <table width="100%" border="0"  style="margin-top: -10px;padding-left: 20px;padding-right: 20px;">    
            <tbody>
                ...
                if(isset($_REQUEST['type'])){
                    ...
                    <td  valign="top" >
                        Bill No:  <?php echo $bill_details->bill_number; ?>
                        <br>
      ...
      <!-- payment history -->
        ...
        if(isset($_REQUEST['type'])){
            ...
            <tbody>
                <tr>
                    <td valign="top" style="width:450px;text-align: right;">Education Tax on Tutuion Fee(1%):</td>
            ...
            <tbody>
                <tr>
                    <td valign="top" style="width:450px;text-align: right;">Net Total:</td>
