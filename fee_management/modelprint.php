           ...
           <form id='form' method='post'  name="create_due_form">
              ...
              <div class="modal-footer"> 
                  <!-- <input readonly="true" onclick="create_receipt_by_class('../student/create_pending_receipt_by_class.php')" class="btn btn-info pull-right" style="color: #fff;background-color: #009688;border-color: #46b8da;width:150px;" name="add_salary" value="Create Receipt"> -->
                   ...
                   <button type="button" onclick="create_receipt_by_class('../student/create_pending_receipt_by_class.php')" class="btn btn-success">Create Due Receipt</button>
                  ...
                  <button type="button" onclick="create_receipt_by_class('../student/horizontal_ledger.php')" class="btn btn-success">Create Due ledger</button>
                 ...
                 <!--  <button type="button" onclick="create_receipt_by_class('../student/create_pending_ladger_by_class.php')" class="btn btn-success">Vertical ladger</button> -->
          </div> 
      </form>
   </div>
        </div>
...
var classId = $("[name='className']").val();
