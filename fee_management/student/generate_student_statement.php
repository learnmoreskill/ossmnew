           ...
           <form id='form' method='post'  name="create_due_form">
              ...
              <div class="col-md-12" style="margin-top: 20px;">
                <div class="form-group">
                  ...
                  <select name="className" class="form-control" id="classname1">
              ...
              <div class="modal-footer"> 
                  ...
                  <button type="button" onclick="create_receipt_by_class('../student/horizontal_ledger.php')" class="btn btn-success">Create ledger</button>
                 <!--  <input readonly="true" onclick="create_ledger_by_class('../student/create_pending_ladger_by_class.php')" class="btn btn-info pull-right" style="width:150px;color: #fff;background-color: #009688;border-color: #46b8da;margin-right: 10px;" name="add_salary" value="Vertical ladger"> -->
                  <button type="button" onclick="create_ledger_by_class('../student/create_pending_ladger_by_class.php')" class="btn btn-success">Vertical ledger</button>
          </div> 
      </form>
   </div>
        </div>
...
<script>
  //var create_due_form = $("[name='create_due_form']");
...
//var className = $('#classname1 option:selected').val();
