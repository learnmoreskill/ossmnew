...
$_SESSION['navactive'] = 'announcementschool';
        ...
        <main>
            <div class="section no-pad-bot" id="index-banner">
                ...
                <div class="github-commit">
                    <div class="container">
                        <div class="row center"><a class="white-text text-lighten-4" href="#">School Announcement</a></div>
                    </div>
                </div>
            </div>
            <?php 
                    ...
                    <div class="col s12 ">
                        <div class="card grey darken-3">
                            <div class="card-content center white-text">
                                <span class="card-title"><span style="color:#80ceff;">No announcement found !!!</span></span>
                            </div>
                        </div>
                    </div>
                </div>
