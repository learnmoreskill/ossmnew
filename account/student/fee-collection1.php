          ...
          <th scope="row">Phone No :</th>
            ...
            <th scope="row">Payment Mode</th>
              <td><?php if($payment_type==0)echo "Monthly"; else echo "Yearly";
               ...
               <?php if($status==0) echo "<td style='color:green;'><b><u>ACTIVE<u><b></td>"; elseif($status==1) echo "<td style='color:red;'><b>INACTIVE<b></td>"; elseif($status==2) echo "<td style='color:gold;'><b>PASSED OUTt<b></td>"; ?>
            </tr>    
          </tbody>
      </table>
    </div>
